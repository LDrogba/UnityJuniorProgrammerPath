...
struct Cube_tEB0CADF2ED5CCD174FE21940A8708AFFBC74872B  : public MonoBehaviour_t532A11E69716D348D8AA7F854AFCBFCB8AD17F71
{
	...
	Vector3_t24C512C7B96BBABAD472002D0BA2BDA40A5A80B2 ___materialColor;
	float ___materialAlpha;
...
{
	{
		...
		Color__ctor_m3786F0D6E510D9CFA544523A955870BD2A514C8C_inline((&L_8), (0.5f), (1.0f), (0.300000012f), (0.400000006f), NULL);
...
{
	{
		Transform_tB27202C6F4E36D225EE28A13E4D662BF99785DB1* L_0;
		L_0 = Component_get_transform_m2919A1D81931E6932C7F06D4C2F0AB8DDA9A5371(__this, NULL);
		Vector3_t24C512C7B96BBABAD472002D0BA2BDA40A5A80B2 L_1 = __this->___rotationAngle;
		float L_2;
		...
		Vector3_t24C512C7B96BBABAD472002D0BA2BDA40A5A80B2 L_9 = __this->___scale;
		float L_10 = __this->___scaleSpeed;
		...
		Vector3_t24C512C7B96BBABAD472002D0BA2BDA40A5A80B2* L_16 = (Vector3_t24C512C7B96BBABAD472002D0BA2BDA40A5A80B2*)(&__this->___materialColor);
		float L_17 = L_16->___x;
		Vector3_t24C512C7B96BBABAD472002D0BA2BDA40A5A80B2* L_18 = (Vector3_t24C512C7B96BBABAD472002D0BA2BDA40A5A80B2*)(&__this->___materialColor);
		float L_19 = L_18->___y;
		Vector3_t24C512C7B96BBABAD472002D0BA2BDA40A5A80B2* L_20 = (Vector3_t24C512C7B96BBABAD472002D0BA2BDA40A5A80B2*)(&__this->___materialColor);
		float L_21 = L_20->___z;
		float L_22 = __this->___materialAlpha;
		Color_tD001788D726C3A7F1379BEED0260B9591F440C1F L_23;
		memset((&L_23), 0, sizeof(L_23));
		Color__ctor_m3786F0D6E510D9CFA544523A955870BD2A514C8C_inline((&L_23), ((float)(L_17/(100.0f))), ((float)(L_19/(100.0f))), ((float)(L_21/(100.0f))), ((float)(L_22/(100.0f))), NULL);
		Material_set_color_m5C32DEBB215FF9EE35E7B575297D8C2F29CC2A2D(L_15, L_23, NULL);
		return;
	}
}
...
{
	{
		...
		__this->___rotationAngle = L_0;
		__this->___scaleSpeed = (10.0f);
		Vector3_t24C512C7B96BBABAD472002D0BA2BDA40A5A80B2 L_1;
		...
		__this->___materialColor = L_3;
		__this->___materialAlpha = (255.0f);
